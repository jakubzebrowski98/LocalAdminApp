<template>
    <div class="card-header">
        <div class="row">
            <div class="col-md">
                <h1 class="dasplay-6">List składników</h1>
            </div>
            <div class="col-md-1">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AddIngModal">
    ...
    <div class="card-body table-responsive">
            ...
            <tbody>
                <tr v-for="(ingredient, index) in ingredients">
                    ...
                    <td class="d-flex justify-content-end">
                        <button class="btn btn-primary btn-sm text-light mx-1" 
                            @click="editIng(ingredient.IngId)"
                            data-bs-toggle="modal" data-bs-target="#EditIngModal">
        ...
        <div class="modal fade" id="EditIngModal" tabindex="-1" aria-labelledby="EditIngModallabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form @submit.stop.prevent="editIng">
                        <div class="modal-header">
                            <h5 class="modal-title" id="EditIngModallabel">Edytuj składnik</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-floating mb-3">
...
<script>
    ...
    export default {
        ...
        setup() {
            const { ingredients, getIng, destroyIng, errors, storeIng } = useIngredients()
